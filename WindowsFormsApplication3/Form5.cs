...
namespace WindowsFormsApplication3 {
    public partial class Form5 : Form {
        ...
        //Image variables
        string pickedImage = "";
        string location = @"C:\\Users\\CLR5-33\\Downloads\\Image\\";
        string fileName = "";
            ...
            if (this.OpenConnection() && idCmbBox.SelectedIndex != -1) {
                try {
                    ...
                    while (reader.Read()) {
                        ...
                        if (reader.GetString("UserImage") == @"C:\Users\CLR5-33\Downloads\Image\")
                        {
                            try
                            {
                                pictureBox1.Image = Image.FromFile(@"C:\Users\CLR5-33\Downloads\Image\no-image.png");
                            }
                            catch (Exception ex)
                            {
